...
register_parser.add_argument(
    "account", type=str, help="Account of the user", required=True
)
register_parser.add_argument("name", type=str, help="Name of the user", required=True)
register_parser.add_argument(
    "password", type=str, help="Password of the user", required=True
)
...
class UserResource(Resource):
    ...
    def post(self):
        ...
        new_user = User(user_id=user_id, account=account, name=name, password=password)
